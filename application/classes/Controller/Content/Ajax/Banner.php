 ...
 * Time: 17:35
  */
class Controller_Content_Ajax_Banner extends Controller_Content_Ajax {
	public function action_list() {
		...
		Session::instance()->set('banner', $page_info);

		$amount = ORM::factory('BannerItem')->count_all();

		$entities = ORM::factory('BannerItem')
