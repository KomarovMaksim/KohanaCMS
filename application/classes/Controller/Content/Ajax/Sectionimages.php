 ...
 * Time: 17:35
  */ 
class Controller_Content_Ajax_SectionImages extends Controller_Content_Ajax {
	public function action_list() {
		...
		Session::instance()->set('sectionimages', $page_info);

		$entities = ORM::factory('SectionImage');
	...
	public function action_sort_up() {
		...
		$entity = ORM::factory('SectionImage', $id);

		$section_id = $entity->section_id;
		$entity = ORM::factory('SectionImage', array('section_id', '=', $section_id), $id);
