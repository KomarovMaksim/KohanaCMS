 ...
 * Time: 17:35
  */ 
class Controller_Content_Ajax_ArticleLinks extends Controller_Content_Ajax {
	public function action_list() {
		...
		Session::instance()->set('articlelinks', $page_info);

		$entities = ORM::factory('ArticleLink');
	...
	public function action_sort_up() {
		...
		$entity = ORM::factory('ArticleLink', $id);

		$article_id = $entity->article_id;
		$entity = ORM::factory('ArticleLink', array('article_id', '=', $article_id), $id);
